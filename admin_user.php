        ...
        <div class = "box-container">
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <p>name: <?php echo $fetch_users['first_name']; ?> <?php echo $fetch_users['last_name']; ?></p>
                    <p>email: <span><?php echo $fetch_users['email']; ?></span></p>
                    <p>user type: <span style="color: <?php if($fetch_users['user_type']=='admin'){echo 'red';}; ?>"><?php echo $fetch_users['user_type']; ?></span></p>
                    <a href="admin_user.php?delete=<?php echo $fetch_users['user_id']; ?>" onclick="return confirm('delete this user account?');" class="delete">delete</a>
                </div>
                <?php
                        }}else{
                            echo '
