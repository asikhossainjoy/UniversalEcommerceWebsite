...
<body>
    ...
    <div class="container-fluid">
        <div class="hero-slider">
            <div class="slider-item">
                <img src="img/supermarket-cart2.png">
            ...
            <div class="grid">
                <div class="grid-wrapper">
                        <div class="grid-image">
                            <?php
                                $category1 = (isset($_GET['view1'])) ? $_GET['view1'] : 0;
                            ?>
                            <a href="category.php?view1=<?php echo $category1 ?>">
                                <img src="img/<?php echo $category1 ?>.png" alt="Grid-01" /></a>
                                
                            
                        </div>
                        <div class="grid-title">
                            <h4><?php echo $category1 ?></h4>
                        </div>
                </div>
            </div>
    ...
    <div class="box-container">
        ...
        <?php
            ...
            $category1 = (isset($_GET['view1'])) ? $_GET['view1'] : 0;
            $select_products=mysqli_query($conn,"SELECT * FROM `products` where `category`='$category1' 
            order by product_id desc") or die('query failed1');
    ...
    <form method="post" action="category.php">
                ...
                <div class="icon">
                    <a href="category.php?view=<?php echo $fetch_products['product_id']; ?>" class="bi bi-eye-fill"></a>
                    <button type="submit" name="wishlist_submit" onclick="return confirm('Want to wishlist this product?')">
                        <i class="bi bi-heart"></i> 
                        
                    </button>
                    <a href="category.php?cart=<?php echo $fetch_products['product_id']; ?>" class="bi bi-cart" onclick="return confirm('Want to cart this product?');"></a>
                </div>
            </form>
        </div>
    ...
    <section class="update-container">
        ...
        <img src="img/<?php echo $fetch_products['image']; 
                ...
                <a href="category.php?cart=<?php echo $fetch_products['product_id']; ?>"class="bi bi-cart" onclick="
                    return confirm('want to cart this product');"></a>
                    <a href="category.php?"class="bi bi-x-lg"></a>
                </div>
        </form>
        <?php 
                    }
